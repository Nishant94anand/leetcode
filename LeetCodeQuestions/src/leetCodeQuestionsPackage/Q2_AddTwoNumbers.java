 ...
 * ----------------------------------------
 * This program reads two numbers as singly linked lists, 
 * where each node contains a single digit, and the digits are stored in reverse order.
 * 
 * It adds the two numbers and returns the sum as a new linked list in the same format.
 * 
 * Example:
...
public class Q2_AddTwoNumbers {
    ...
    /**
     * Adds two non-negative integers represented by linked lists.
